let handler = async(m, { hanz }) => {
  await hanz.sendFile(m.chat, pickRandom(global.renungan), 'renungan.jpeg', 'Nih Renunganmu, Jangan Lupa Dijadikan Pelajaran Yah Buat Masa Depan Nanti...', m)
}
handler.help = ['renungan']
handler.tags = ['internet']
handler.command = /^(quotesrenungan)$/i
handler.owner = false
handler.mods = false
