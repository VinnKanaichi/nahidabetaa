...
let handler = async (m, hanz,command, sendButDoc) => {
    let motivasi = `${gris1}${pickRandom(global.motivasi)}${gris1}`;
   /* await conn.sendMessage(m.chat, {
    ...
    sendButDoc(motivasi,'Next..','quotesmotivasi')
};

handler.help = ['motivasi']
handler.tags = ['quotes']
handler.command = /^(quotesmotivasi)$/i
handler.limit = true
